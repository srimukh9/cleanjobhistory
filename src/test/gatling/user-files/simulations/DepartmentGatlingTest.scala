...
class DepartmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Department entity")
        ...
        .repeat(2) {
            ...
            .get("/services/simplejobhistory/api/departments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new department")
            .post("/services/simplejobhistory/api/departments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "departmentName":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/simplejobhistory${new_department_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created department")
            .delete("/services/simplejobhistory${new_department_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
