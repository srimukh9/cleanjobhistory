...
import com.amazon.simplejobhistory.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.amazon.simplejobhistory.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "simplejobhistoryJobHistory";
